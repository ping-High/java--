...
public class SynonymCode {
    ...
    public void init() throws  Exception{
        String dicPath = this.getClass().getClassLoader().getResource("NEW.txt").getPath();//TODO 资源： 300k行的词典
        String line = null;
        long time = System.currentTimeMillis();
        BufferedReader br;

        br = new BufferedReader(new InputStreamReader( new FileInputStream(dicPath),"unicode"));
